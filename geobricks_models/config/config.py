...
config = {
    ...
    "settings": {
        ...
        # Folders
        "folders": {
            "tmp": "/media/vortex/LaCie/nena/geobricks_filesystem/tmp/",
            "geoserver_datadir": "/media/vortex/LaCie/nena/geobricks_filesystem/data/geoserver_data_dir/",
            "storage": "/media/vortex/LaCie/nena/geobricks_filesystem/data/storage/",
